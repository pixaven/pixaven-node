...
/**
* Read and cache CA certificate store
*/

const caFile = fs.readFileSync(path.resolve(__dirname, "data/cacert.pem"));
...
const client = {
    ...
    /**
    * Sends a HTTP request to the Pixaven Image API
    *
        ...
        */
        ...
        if (options.withUpload) {
            ...
            */
            ...
            reqOptions.url = "https://api.pixaven.com/1.0/upload";
            ...
            reqOptions.url = "https://api.pixaven.com/1.0/fetch";
            ...
            */
            ...
            req.on("response", (res) => {
                ...
                */
                ...
                if (res.headers && res.headers["x-pixaven-meta"]) {
                    try {
                        meta = JSON.parse(res.headers["x-pixaven-meta"]);
                    } catch (e) {
                        if (!cb.called) {
                            return cb(new Error("Unable to parse JSON response from the Pixaven Image API"));
                        }
                    }
                } else {
                    meta = {};
